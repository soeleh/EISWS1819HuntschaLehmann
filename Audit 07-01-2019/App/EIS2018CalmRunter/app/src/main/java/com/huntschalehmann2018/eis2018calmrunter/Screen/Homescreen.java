...
public class Homescreen extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout banner1 = findViewById(R.id.homescreen_startLerneinheit);
        banner1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Homescreen.this, Karteikartenstapel_Auswaehlen.class));
            }
        });

        RelativeLayout banner2 = findViewById(R.id.homescreen_showKarteikarten);
        ...
        RelativeLayout banner3 = findViewById(R.id.homescreen_showProfile);
